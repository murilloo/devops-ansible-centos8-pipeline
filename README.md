...
## Tasks
- To properly configure a *secondary* network interface in the server. __Please check [this issue](https://github.com/ansible/ansible/pull/62609) from nmcli Ansible module__
